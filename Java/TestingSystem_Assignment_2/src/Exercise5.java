...
//Bước 1: In ra tên các usernames của user cho người dùng xem				
		...
		{
				System.out.println( i+1+"." +"UserName: " + accounts[i].userName);
...
//Bước 2: Yêu cầu người dùng nhập vào username của account	
		...
		switch (userName) {
		case "haidang":
			groupAcc.accounts = account1;
			break;
		case "huyluc":
			groupAcc.accounts = account2;
			break;
		case "quanganh":
			groupAcc.accounts = account3;
			break;
		default:
		...
		System.out.println("Username: " + groupAcc.accounts.userName);
